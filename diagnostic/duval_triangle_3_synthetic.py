# -*- coding: utf-8 -*-
"""duval_triangle_3_synthetic.py

This module calculates duval triangle 3 (synthetic ester) related diagnostics and generates duval triangle visualizations using plotly library.
...
# * Triangle 3 (synthetic ester) fault area ternary coordinate constants (plotly: a, b, c) *
TRIANGLE_3_SYNTH_PD_A = [100, 98, 98, 100]
TRIANGLE_3_SYNTH_PD_B = [0, 2, 0, 0]
TRIANGLE_3_SYNTH_PD_C = [0, 0, 2, 0]

TRIANGLE_3_SYNTH_T1_A = [96, 57, 61, 98, 98, 96]
TRIANGLE_3_SYNTH_T1_B = [4, 4, 0, 0, 2, 4]
TRIANGLE_3_SYNTH_T1_C = [0, 39, 39, 2, 0, 0]

TRIANGLE_3_SYNTH_T2_A = [61, 57, 28, 32, 61]
TRIANGLE_3_SYNTH_T2_B = [0, 4, 4, 0, 0]
TRIANGLE_3_SYNTH_T2_C = [39, 39, 68, 68, 39]

TRIANGLE_3_SYNTH_T3_A = [32, 17, 0, 0, 32]
TRIANGLE_3_SYNTH_T3_B = [0, 15, 15, 0, 0]
TRIANGLE_3_SYNTH_T3_C = [68, 68, 85, 100, 68]

TRIANGLE_3_SYNTH_DT_A = [87, 47, 31, 0, 0, 17, 28, 96, 87]
TRIANGLE_3_SYNTH_DT_B = [13, 13, 29, 29, 15, 15, 4, 4, 13]
TRIANGLE_3_SYNTH_DT_C = [0, 40, 40, 71, 85, 68, 68, 0, 0]

TRIANGLE_3_SYNTH_D1_A = [0, 0, 61, 87, 0]
TRIANGLE_3_SYNTH_D1_B = [100, 74, 13, 13, 100]
TRIANGLE_3_SYNTH_D1_C = [0, 26, 26, 0, 0]

TRIANGLE_3_SYNTH_D2_A = [61, 0, 0, 31, 47, 61]
TRIANGLE_3_SYNTH_D2_B = [13, 74, 29, 29, 13, 13]
TRIANGLE_3_SYNTH_D2_C = [26, 26, 71, 40, 40, 26]


def create_duval_3_synth_colorized(legend_show=False):
    ...
    #PD
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_PD_A,
                                    b= TRIANGLE_3_SYNTH_PD_B,
                                    c= TRIANGLE_3_SYNTH_PD_C,
                                    name='PD',
    ...
    #T1
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_T1_A,
                                    b= TRIANGLE_3_SYNTH_T1_B,
                                    c= TRIANGLE_3_SYNTH_T1_C,
                                    name='T1',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    #T2
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_T2_A,
                                    b= TRIANGLE_3_SYNTH_T2_B,
                                    c= TRIANGLE_3_SYNTH_T2_C,
                                    name='T2',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    #T3
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_T3_A,
                                    b= TRIANGLE_3_SYNTH_T3_B,
                                    c= TRIANGLE_3_SYNTH_T3_C,
                                    name='T3',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    #DT
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_DT_A,
                                    b= TRIANGLE_3_SYNTH_DT_B,
                                    c= TRIANGLE_3_SYNTH_DT_C,
                                    name='DT',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    #D1
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_D1_A,
                                    b= TRIANGLE_3_SYNTH_D1_B,
                                    c= TRIANGLE_3_SYNTH_D1_C,
                                    name='D1',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    #D2
    fig.add_trace(go.Scatterternary(a= TRIANGLE_3_SYNTH_D2_A,
                                    b= TRIANGLE_3_SYNTH_D2_B,
                                    c= TRIANGLE_3_SYNTH_D2_C,
                                    name='D2',
                                    showlegend=legend_show,
                                    mode='lines',
                                    line_color='black',
    ...
    # Annotations
    fig.add_scatterternary(a=[20, 20, 30, 99, 78, 43, 12.5], 
                           b=[68.5, 40, 15, 0.5, 2, 2, 7.5], 
                           c=[11.5, 40, 55, 0.5, 20, 55, 80],
                           text=['D1', 'D2', 'DT', 'PD', 'T1', 'T2', 'T3'],
...
def create_duval_3_synth_nocolor(legend_show=False):
    # https://community.plotly.com/t/shapes-in-ternary-plot/38566/10
    # https://plotly.com/python/reference/layout/ternary/
    fig = go.Figure(layout=dict(ternary_sum=100))
    #PD
...
def calculate_duval_3_synth_coordinates(ch4, c2h2, c2h4, rounding=False):
...
def calculate_duval_3_synth_result(ch4, c2h2, c2h4):
    try:
        ...
        if (ch4 == 0) and (c2h2 == 0) and (c2h4 == 0):
            ...
            x, y, z = calculate_duval_3_synth_coordinates(ch4, c2h2, c2h4)
            if x >= 98:
                return 'PD'
            elif z <= 26 and y >= 13:
                return 'D1'
            elif (z <= 40 and z > 26 and y >= 13) or (z >= 40 and y >= 29):
                return 'D2'
            elif x < 98 and z <= 39 and y <= 4:
                return 'T1'
            elif  z > 39 and z < 68 and y <= 4:
                return 'T2'
            elif y <= 15 and z >= 68:
                return 'T3'
            elif (z <= 39 and y > 4 and y < 13 ) or (z > 39 and z < 68 and y > 4 and y < 29) or (z >= 68 and y > 15 and y < 29):
                return 'DT'
            else:
                return 'ND'
    except TypeError:
...
def create_duval_3_synth_marker(ch4, c2h2, c2h4, **kwargs):
    marker_coordinates = calculate_duval_3_synth_coordinates(ch4, c2h2, c2h4)
    result = calculate_duval_3_synth_result(ch4, c2h2, c2h4)
...
def create_duval_3_synth_result_graph(ch4, c2h2, c2h4):
    fig = create_duval_3_synth_colorized()

    try:
        result_name = calculate_duval_3_synth_result(ch4, c2h2, c2h4)
        fig.add_trace(create_duval_3_synth_marker(ch4, c2h2, c2h4, result_name))
        return fig
    except:
        return fig

def create_duval_3_synth_multi_results_graph(samples_df):
    fig = create_duval_3_synth_colorized()
    ...
    try:
        ...
        for row in samples_df.itertuples(name=None):
            ...
            if (ch4 == 0) and (c2h2 == 0) and (c2h4 == 0):
                ...
                duval_result = calculate_duval_3_synth_result(ch4, c2h2, c2h4)
                mark_name = f'{duval_result} {time}'
                fig.add_trace(create_duval_3_synth_marker(ch4, c2h2, c2h4, marker_name=mark_name, timestamp=time, marker_color=rowcolor))
        return fig
    except Exception as e:
        print(e)
        return fig
    
def create_duval_3_synth_group_graph(ch4_groups, c2h2_groups, c2h4_groups, group_names, colorized=True, **kwargs):
    ...
    if colorized is True:
        ...
        fig = create_duval_3_synth_nocolor()
        ...
        for i, group_name in enumerate(group_names):
            ...
            for ch4_value, c2h2_value, c2h4_value in zip(ch4_groups[i], c2h2_groups[i], ch4_groups[i]):
                if (ch4_value == 0) and (c2h2_value == 0) and (c2h4_value == 0):
                    continue
                coord_list.append(calculate_duval_3_synth_coordinates(ch4_value, c2h2_value, c2h4_value))
...
if __name__ == "__main__":
    '''
    fig = create_duval_3_synth_nocolor()
    duval_result = calculate_duval_3_synth_result(10, 26, 64)
    fig.add_trace(create_duval_3_synth_marker(10, 26, 64, marker_name=duval_result))
    fig.show()
    '''

    fig2 = create_duval_3_synth_colorized()
    fig2.add_trace(create_duval_3_synth_marker(10, 26, 64))
    fig2.add_trace(create_duval_3_synth_marker(56, 26, 64, timestamp='2021-05-11'))
    fig2.show()

    '''

    #fig3 = create_duval_3_synth_result_graph(55, 8, 55)
    #fig3.show()
    ...
    #fig4 = create_duval_3_synth_multi_results_graph(df_sample)
    #fig4.show()
    ...
    fig5 = create_duval_3_synth_group_graph(ch4_list, c2h2_list, c2h4_list, groups_list, colorized=False, group_colors=['rgb(136, 204, 238)', 'rgb(204, 102, 119)', 'rgb(221, 204, 119)', 'rgb(17, 119, 51)'])
    fig5.show()
    '''